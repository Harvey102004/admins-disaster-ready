...
export default function RoadAdvisoryEditFormModal() {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: async (data: RoadType) => {
      return await toast.promise(editRoadAvisory({ id: editId, data }), {
        loading: "Updating road advisory...",
        success: () => "Road advisory updated successfully!",
